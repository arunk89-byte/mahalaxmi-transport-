  ...
  return (
    <div>
      ...
      <p className="text-slate-600 leading-relaxed mb-8">
        We are proud to serve some of the most trusted names in the cotton and textile industry. Our reliable transportation services have earned the trust of leading corporations pan India.
      </p>
        ...
        <div className="bg-white p-6 rounded-lg ring-1 ring-slate-200 hover:ring-2 hover:ring-black hover:shadow-lg hover:-translate-y-1 hover:scale-102 transition-all duration-300 cursor-pointer group">
          <div className="aspect-[3/2] flex items-center justify-center">
            <div className="text-center group-hover:scale-105 transition-transform duration-300">
              ...
              <div className="text-sm text-slate-600 group-hover:text-slate-800 transition-colors duration-300">Leading textile mills and cotton traders pan India</div>
            </div>
          </div>
        </div>
      </div>
