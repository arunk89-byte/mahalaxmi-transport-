  ...
  return (
    <div>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-6">
        <div className="text-center p-6 bg-blue-50 rounded-lg border border-blue-200 hover:ring-2 hover:ring-black hover:shadow-lg hover:-translate-y-1 hover:scale-102 transition-all duration-300 cursor-pointer">
        ...
        <div className="text-center p-6 bg-emerald-50 rounded-lg border border-emerald-200 hover:ring-2 hover:ring-black hover:shadow-lg hover:-translate-y-1 hover:scale-102 transition-all duration-300 cursor-pointer">
        ...
        <div className="text-center p-6 bg-orange-50 rounded-lg border border-orange-200 hover:ring-2 hover:ring-black hover:shadow-lg hover:-translate-y-1 hover:scale-102 transition-all duration-300 cursor-pointer">
