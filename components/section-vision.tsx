  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        <div className="bg-gradient-to-r from-blue-50 to-emerald-50 p-8 rounded-lg border-l-4 border-blue-700">
        ...
        <div className="bg-gradient-to-r from-emerald-50 to-orange-50 p-8 rounded-lg border-l-4 border-emerald-700">
          <blockquote className="text-slate-700 leading-relaxed text-lg italic mb-4">
